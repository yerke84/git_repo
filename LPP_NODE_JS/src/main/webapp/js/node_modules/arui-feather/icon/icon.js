...
var _cn3 = _interopRequireDefault(_cn2);
 ...
 */
var Icon = (_dec = (0, _cn3.default)('icon'), _dec2 = (0, _performance2.default)(), _dec(_class = _dec2(_class = (_class2 = (_temp = _class3 = function (_React$Component) {
    ...
    /** Тип иконки */
    icon: _propTypes2.default.oneOf(['error', 'fail', 'ok', 'ok_filled', 'calendar', 'search', 'close', 'user']),
    /** Размер компонента */
