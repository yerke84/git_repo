...
public class Test_Portlet_Session_Sender extends MVCPortlet {
	...
	public void myAction(ActionRequest req, ActionResponse resp) {
		...
		/*
		 1) in sender and receiver portlet tag must be this setting:
		 <portlet>
		 	****
		 	<supported-public-render-parameter>RP_LNAME</supported-public-render-parameter>
		 	****
		 </portlet>  
		 ...
		 <portlet-app>
		 	****
		 	<public-render-parameter>
				<identifier>RP_LNAME</identifier>
				<qname xmlns:x="http://www.liferay.com/public-render-parameters">x:RP_LNAME</qname>
			</public-render-parameter>
			****
		</portlet-app>
