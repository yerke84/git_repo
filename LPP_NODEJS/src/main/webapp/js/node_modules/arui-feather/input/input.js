...
var Input = (_dec = (0, _cn2.default)('input', _maskedInput2.default), _dec2 = (0, _performance2.default)(), _dec(_class = _dec2(_class = (_class2 = (_temp2 = _class3 = function (_React$Component) {
    ...
    _createClass(Input, [{
        ...
        value: function render(cn, MaskedInput) {
            ...
            var content = this.renderContent(cn, MaskedInput);
            if (hasAddons) {
                content = _react2.default.createElement(
                    'span',
                    { className: cn('addons-layout') },
                    content
                );
            }
        ...
        value: function renderContent(cn, MaskedInput) {
            return [this.props.leftAddons && _react2.default.createElement(
                'span',
                { className: cn('addons', { left: true }), key: 'left-addons' },
                this.props.leftAddons
            ), this.renderInput(cn, MaskedInput), this.props.rightAddons && _react2.default.createElement(
                'span',
        ...
        key: 'renderInput',
        value: function renderInput(cn, MaskedInput) {
            var _this3 = this;
